...
/**********************************************************************************************************
								Functiuons Declaration
***********************************************************************************************************/
void AppendCrc(void);
void FromWriteSingleCoil(void);
void DoSensorTest(void);
...
void CallTxDelay(int);
void SendMDBResponse(unsigned char);
void ComputeMdbResponse(unsigned char);

extern void InitUART1(void);
extern void ConvertFloatToHex(char *);
void ClearRx1Buffer(void);
...
long int TxDelay = 80000;
int NoOfBytes=0;
unsigned char MdbRes = 0;
unsigned char TestState = 0;
unsigned char CrcSize = 0;
unsigned char CRCHi = 0xFF;	
unsigned char CRCLo = 0xFF;
unsigned char WeightData = 0;
unsigned char MdbReq[20];
unsigned char WriteCoil[2];
...
extern unsigned char HighBp;
extern unsigned char PulseRate;

...
src/Main.obj: ../src/Main.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"/home/preetham/ti/ccsv6/tools/compiler/ti-cgt-arm_15.12.1.LTS/bin/armcl" -mv7M3 --code_state=16 -me --fp_mode=relaxed --opt_for_speed=1 --include_path="/home/preetham/ti/ccsv6/tools/compiler/ti-cgt-arm_15.12.1.LTS/include" --include_path="/home/preetham/workspace_v6_1_3/Modbus-Slave/F28M35H52C_System" --include_path="/home/preetham/workspace_v6_1_3/Modbus-Slave/inc" -g --gcc --define=ccs --define=__GNUC__ --diag_wrap=off --display_error_number --diag_warning=225 --gen_func_subsections=on --abi=eabi --ual --preproc_with_compile --preproc_dependency="src/Main.d" --obj_directory="src" $(GEN_OPTS__FLAG) "$(shell echo $<)"

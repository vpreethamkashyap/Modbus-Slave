//###########################################################################
// FILE:   softuart.h
// TITLE:  Defines and macros for the SoftUART.
//###########################################################################
...
typedef struct
{
        ...
        //! The address of the GPIO pin to be used for the Tx signal.  This
        //! member can be set via a direct structure access or using the
        //! SoftUARTTxGPIOSet function.
        unsigned long ulTxGPIO;

        //! The address of the GPIO port to be used for the Rx signal.  This
        //! member can be set via a direct structure access or using the
        //! SoftUARTRxGPIOSet function.
        ...
        //! The length of the transmit buffer.  This member can be set via a
        //! direct structure access or using the SoftUARTTxBufferSet function.
        ...
        //! The transmit buffer level at which the transmit interrupt is
        //! asserted. This member should not be accessed or modified by the
	//! application.
        unsigned short usTxBufferLevel;

        //! The length of the receive buffer.  This member can be set via a
        //! direct structure access or using the SoftUARTRxBufferSet function.
        unsigned short usRxBufferLen;

        //! The index into the receive buffer of the next character to be read
        //! from the buffer.  This member should not be accessed or modified by
	//! the application.
        unsigned short usRxBufferRead;

        //! The index into the receive buffer of the lcoation to store the next
        //! character received.  This member should not be accessed or modified
        //! by the application.
        ...
        //! The set of virtual interrupts that are currently asserted.  This
        ...
        //! The configuration of the SoftUART module.  This member can be set
        //! via the SoftUARTConfigSet and SoftUARTFIFOLevelSet functions.
        ...
        //! The current state of the SoftUART transmit state machine.  This
        //! member should not be accessed or modified by the application.
        ...
        //! The GPIO pin to be used for the Rx signal.  This member can be set
        //! via a direct structure access or using the SoftUARTRxGPIOSet 
	//! function.
        unsigned char ucRxPin;

        //! The current state of the SoftUART receive state machine.  This
        //! member should not be accessed or modified by the application.
        ...
        //! reception of the current character via the Rx pin.  This member
        //! should not be accessed or modified by the application.
        unsigned char ucRxFlags;

        //! The receive error status.  This member should only be accessed via
        //! the SoftUARTRxErrorGet and SoftURATRxErrorClear functions.
...
#define SOFTUART_CONFIG_WLEN_MASK                                             \
                                         0x00000060 // Mask for extracting word
                                                    // length
...
#define SOFTUART_CONFIG_STOP_MASK                                             \
                                         0x00000008 // Mask for extracting stop
                                                    // bits
...
#define SOFTUART_CONFIG_PAR_MASK                                              \
                                         0x00000086 // Mask for extracting
                                                    // parity
...
//*****************************************************************************
#define SOFTUART_FIFO_TX1_8              0x00000000 // Transmit interrupt at 1/8
                                                    // Full
#define SOFTUART_FIFO_TX2_8              0x00000001 // Transmit interrupt at 1/4
                                                    // Full
#define SOFTUART_FIFO_TX4_8              0x00000002 // Transmit interrupt at 1/2
                                                    // Full
#define SOFTUART_FIFO_TX6_8              0x00000003 // Transmit interrupt at 3/4
                                                    // Full
#define SOFTUART_FIFO_TX7_8              0x00000004 // Transmit interrupt at 7/8
                                                    // Full
...
//*****************************************************************************
#define SOFTUART_FIFO_RX1_8              0x00000000 // Receive interrupt at 1/8
                                                    // Full
#define SOFTUART_FIFO_RX2_8              0x00000008 // Receive interrupt at 1/4
                                                    // Full
#define SOFTUART_FIFO_RX4_8              0x00000010 // Receive interrupt at 1/2
                                                    // Full
#define SOFTUART_FIFO_RX6_8              0x00000018 // Receive interrupt at 3/4
                                                    // Full
#define SOFTUART_FIFO_RX7_8              0x00000020 // Receive interrupt at 7/8
                                                    // Full
